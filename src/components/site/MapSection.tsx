                ...
                return (
                  ...
                  >
                    ...
                    <rect
                      ...
                      ry={8}
                      fill="none"
                      // Use the brand color for the halo so the party logo itself isn't forced to a pink/purple theme
                      stroke={"var(--brand)"}
                      strokeWidth={2}
                      opacity={0.45}
                      pointerEvents="none"
                    ...
                    <rect
                      ...
                      rx={8}
                      ry={8}
                      // keep marker background white so logos render with their original colors
                      fill={"white"}
                      stroke={"var(--brand)"}
                    ...
                    <text
                      y={-27}
                      textAnchor="middle"
                      className={`text-[15px] font-semibold fill-foreground`}
                      pointerEvents="none"
                    >
                      {machine.city}
                    </text>
...
//       <div className="flex items-start justify-between gap-3 p-5 pb-0 sm:p-7 sm:pb-0">
//         <div className="min-w-0">
//           {festival && <span className="party-chip">Partybox edition</span>}
//           <h3 className="mt-2 text-xl font-extrabold tracking-tight">{machine.name}</h3>
//         </div>
//         <button
//           onClick={onClose}
